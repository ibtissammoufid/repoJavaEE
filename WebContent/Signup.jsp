		...
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form validate-form" action="Signup" method="post">
					...
					<div class="wrap-input100 validate-input" data-validate = "Enter your city">
						<input class="input100" type="text" name="ville">
						<span class="focus-input100" data-placeholder="ville"></span>
					</div>
					<div class="wrap-input100 validate-input" data-validate = "Valid email is: example@b.c">
