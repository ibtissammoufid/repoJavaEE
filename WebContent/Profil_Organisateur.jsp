...
<body class="subpage">
		...
		<div class="container body-content">
			...
			<div class="container">
				...
				<%
					...
					String email_organisateur = (String) session.getAttribute("email_organisateur");
					org = Profil_Organisateur.Afficher_Info_Organisateur(email_organisateur);
				%>
	...
	<div class="container body-content">
		...
		0<%=org.getContact_Organisateur()%><br> <i
